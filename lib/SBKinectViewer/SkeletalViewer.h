...
public:
	...
	void                    processAndSendSkeleton( const NUI_SKELETON_DATA & skel);
...
private:
	...
	// added for sending in skeleton information
	bool          m_initSkeleton;
	int           m_initSkeletonCount;
	std::vector<int> m_skeletonJointMapping;
};
