...
/*
    ...
    EMSCRIPTEN_BUILD - defined for any Escripten build
...
#if defined(EMSCRIPTEN)  // must be done before windows check because _WIN32 is mistakenly defined on emscripten builds, reported by AS and ZW 7/24/15
   #undef _WIN32
