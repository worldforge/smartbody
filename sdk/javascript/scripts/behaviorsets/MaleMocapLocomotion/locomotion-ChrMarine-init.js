var locomotionChrMarineInit = {
	//locomotion mirror
	locomotionChrMarineInit : function(){
		if(scene.getMotion('ChrMarine@WalkCircleLf01') == null){
			//locomotion smooth cycle
			console.log('locomotion smooth cycle')
			var smoothMotion = scene.getMotion("ChrMarine@RunCircleRt01")
			...
			var mirrorMotion = scene.getMotion("ChrMarine@WalkCircleRt01")
