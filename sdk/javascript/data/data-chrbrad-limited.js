...
(function() {
    ...
    var PACKAGE_NAME = './data-chrbrad-limited.data';
    var REMOTE_PACKAGE_BASE = 'data-chrbrad-limited.data';
    ...
    var REMOTE_PACKAGE_SIZE = 16173107;
    var PACKAGE_UUID = '4257a6aa-6d75-4cd0-954d-a28cdf4e6b73';
...
Module['FS_createPath']('/ChrBrad', 'mesh', true, true);
    ...
    new DataRequest(12023949, 12296600, 0, 0).open('GET', '/ChrBrad/mesh/ChrBrad_EyeBrown01_Dif.png');
    new DataRequest(12296600, 12463177, 0, 0).open('GET', '/ChrBrad/mesh/ChrBrad_Eyelash_Dif.png');
    new DataRequest(12463177, 12465011, 0, 0).open('GET', '/ChrBrad/mesh/ChrBrad_EyeShell_Dif.png');
    new DataRequest(12465011, 12726906, 0, 0).open('GET', '/ChrBrad/mesh/ChrBrad_Eye_Dif.png');
    new DataRequest(12726906, 12949724, 0, 0).open('GET', '/ChrBrad/mesh/ChrBrad_Hair_Dif.png');
    new DataRequest(12949724, 13208411, 0, 0).open('GET', '/ChrBrad/mesh/ChrBrad_Hands_Dif.png');
    new DataRequest(13208411, 13354665, 0, 0).open('GET', '/ChrBrad/mesh/ChrBrad_Hands_Nrm.png');
    new DataRequest(13354665, 13838367, 0, 0).open('GET', '/ChrBrad/mesh/ChrBrad_Head_Dif.png');
    new DataRequest(13838367, 14047322, 0, 0).open('GET', '/ChrBrad/mesh/ChrBrad_Head_Nrm.png');
    new DataRequest(14047322, 14476518, 0, 0).open('GET', '/ChrBrad/mesh/ChrBrad_LowerBody_Dif.png');
    new DataRequest(14476518, 14758664, 0, 0).open('GET', '/ChrBrad/mesh/ChrBrad_LowerBody_Nrm.png');
    new DataRequest(14758664, 15047297, 0, 0).open('GET', '/ChrBrad/mesh/ChrBrad_Shoes_Dif.png');
    new DataRequest(15047297, 15210034, 0, 0).open('GET', '/ChrBrad/mesh/ChrBrad_Shoes_Nrm.png');
    new DataRequest(15210034, 15471386, 0, 0).open('GET', '/ChrBrad/mesh/ChrBrad_Teeth_Dif.png');
    new DataRequest(15471386, 15599685, 0, 0).open('GET', '/ChrBrad/mesh/ChrBrad_Teeth_Nrm.png');
    new DataRequest(15599685, 15652498, 0, 0).open('GET', '/ChrBrad/mesh/ChrBrad_Teeth_Spc.png');
    new DataRequest(15652498, 15921339, 0, 0).open('GET', '/ChrBrad/mesh/ChrBrad_UpperBody_Dif.png');
    new DataRequest(15921339, 16173107, 0, 0).open('GET', '/ChrBrad/mesh/ChrBrad_UpperBody_Nrm.png');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          Module['removeRunDependency']('datafile_./data-chrbrad-limited.data');

    };
    Module['addRunDependency']('datafile_./data-chrbrad-limited.data');
