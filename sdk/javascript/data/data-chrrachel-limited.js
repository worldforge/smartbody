...
(function() {
    ...
    var PACKAGE_NAME = './data-chrrachel-limited.data';
    var REMOTE_PACKAGE_BASE = 'data-chrrachel-limited.data';
    ...
    var REMOTE_PACKAGE_SIZE = 9615748;
    var PACKAGE_UUID = '1e222117-80e8-45e7-9e81-b1129fe8e63f';
...
Module['FS_createPath']('/ChrRachel', 'mesh', true, true);
    ...
    new DataRequest(8186042, 8337547, 0, 0).open('GET', '/ChrRachel/mesh/ChrRachel_Hair_Nrm.png');
    new DataRequest(8337547, 8789479, 0, 0).open('GET', '/ChrRachel/mesh/ChrRachel_Head_Dif.png');
    new DataRequest(8789479, 8940984, 0, 0).open('GET', '/ChrRachel/mesh/ChrRachel_Head_Nrm.png');
    new DataRequest(8940984, 9123490, 0, 0).open('GET', '/ChrRachel/mesh/ChrRachel_LowerBody_Dif.png');
    new DataRequest(9123490, 9214065, 0, 0).open('GET', '/ChrRachel/mesh/ChrRachel_LowerBody_Nrm.png');
    new DataRequest(9214065, 9492339, 0, 0).open('GET', '/ChrRachel/mesh/ChrRachel_UpperBody_Dif.png');
    new DataRequest(9492339, 9615748, 0, 0).open('GET', '/ChrRachel/mesh/ChrRachel_UpperBody_Nrm.png');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          Module['removeRunDependency']('datafile_./data-chrrachel-limited.data');

    };
    Module['addRunDependency']('datafile_./data-chrrachel-limited.data');
