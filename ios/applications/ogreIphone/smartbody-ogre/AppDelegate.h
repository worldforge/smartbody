...
- (void)go {
    ...
    // add subview Yuyu
    InputViewController* inputController = [[InputViewController alloc] initWithFrame:CGRectMake(0, 0, 768, 1024 )];
    ...
    [mUIWindow addSubview:inputController];
    [mUIWindow bringSubviewToFront:inputController];
