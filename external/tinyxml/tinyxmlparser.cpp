...
TiXmlNode* TiXmlNode::Identify( const char* p, TiXmlEncoding encoding )
{
	...
	{
		#ifdef DEBUG_PARSER
			TIXML_SmartBody::util::log( "XML parsing Stylesheet Reference\n" );
		#endif
	...
	{
		#ifdef DEBUG_PARSER
			TIXML_SmartBody::util::log( "XML parsing Declaration\n" );
		#endif
	...
	{
		#ifdef DEBUG_PARSER
			TIXML_SmartBody::util::log( "XML parsing Comment\n" );
		#endif
	...
	{
		#ifdef DEBUG_PARSER
			TIXML_SmartBody::util::log( "XML parsing CDATA\n" );
		#endif
	...
	{
		#ifdef DEBUG_PARSER
			TIXML_SmartBody::util::log( "XML parsing Unknown(1)\n" );
		#endif
	...
	{
		#ifdef DEBUG_PARSER
			TIXML_SmartBody::util::log( "XML parsing Element\n" );
		#endif
	...
	{
		#ifdef DEBUG_PARSER
			TIXML_SmartBody::util::log( "XML parsing Unknown(2)\n" );
		#endif
		returnNode = new TiXmlUnknown();
	}
