...
namespace Log
{
   ...
   class Logger
   {
      ...
      public:
         ...
         void UseFileConfig( const char * filename );

         bool IsEnabled() const;

	  void updateListener(std::string& message);
      ...
      protected:
         void AddVHCLAppender();

      private:
         friend class VHCLLog4CxxAppender;
   };
