...
extern GLvoid   glEnable_wes(GLenum e);
extern GLvoid   glDisable_wes(GLenum e);

extern GLvoid   glDrawArrays_wes(GLenum mode, GLint off, GLint num);
extern GLvoid   glDrawElements_wes(GLenum mode, GLsizei count, GLenum type, const GLvoid *indices);
...
extern GLvoid   glActiveTexture_wes(GLenum texture);
...
/*  Texture     */
extern GLvoid   glTexImage2D_wes(GLenum target, GLint level, GLenum internalFormat, GLsizei width, GLsizei height,
