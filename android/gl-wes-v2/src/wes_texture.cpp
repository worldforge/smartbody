...
GLvoid
glTexImage2D_wes(GLenum target, GLint level, GLenum internalFormat, GLsizei width, GLsizei height,
                ...
                GLenum format, GLenum type, const GLvoid *pixels )
{
    ...
    glTexImage2D_wes(target, 0, format, width, height, 0, format, type, pixels);
    ...
    while(width != 1 || height != 1){
        ...
        glTexImage2D_wes(target, i++, format, width, height, 0, format, type, newdata);
        free(data);
        data = newdata;
    }
