...
// * Inputs: The operation to be performed, the number of arguments, and the arguments
// * Output: TTU_ERROR or TTU_SUCCESS
int ttu_notify( const char * opname, const int argc, const char ** argv );

// ttu_notify1
// * Sends a notification
// * Inputs: Some string to be sent over vhmsg.  The first variable
// * its the operations name, the rest are arguments to be sent
// * Output: TTU_ERROR or TTU_SUCCESS
int ttu_notify1( const char * args );

// ttu_notify2
// * Sends a notification
// * Inputs: The operation to be performed, and a argument
// * Output: TTU_ERROR or TTU_SUCCESS
