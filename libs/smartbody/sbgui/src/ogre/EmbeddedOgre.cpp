...
void EmbeddedOgre::createOgreWindow( void* windowHandle, void* parentHandle, unsigned long glContext, int width, int height, std::string windowName )
{
	...
	try 
	{		
		ogreRoot = new Ogre::Root("c:/users/shapi/avatarchat/smartbody/libs/smartbody/sbgui/bin64/plugins.cfg", "", "ogre.log");
...
/*
		...
		*/
		...
		setupResource("c:/users/shapi/avatarchat/smartbody/libs/smartbody/sbgui/bin64/resources.cfg");
