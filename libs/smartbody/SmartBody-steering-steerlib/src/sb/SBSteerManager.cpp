		  ...
		  _maxUpdateFrequency(1)
{
	...
	createStringAttribute("engineOptions.testCaseSearchPath", "../../../../libs/smartbody/steersuite-1.3/testcases/", true, "Basic", 60, false, false, false, "Path to find test cases");
