...
//		static DOMNode* getNode(const std::string& nodeName, std::string fileName);
		...
		static SBAPI bool exportCollada(SmartBody::SBRenderAssetManager& renderAssetManager, std::string outPathname, std::string skeletonName, std::string deformMeshName, std::vector<std::string> motionNames, bool exportSk, bool exportMesh, bool exportMotion, double meshScale);
		static bool exportVisualScene( SmartBody::SBRenderAssetManager& renderAssetManager,FILE* fp, std::string skeletonName, std::string defMeshName, double scale);
		static bool exportSkinMesh(SmartBody::SBRenderAssetManager& renderAssetManager, FILE* fp, std::string deformMeshName, double scale, std::string skeletonName);
		static bool exportMaterials(SmartBody::SBRenderAssetManager& renderAssetManager, FILE* fp, std::string deformMeshName);
		static bool exportMotions(SmartBody::SBRenderAssetManager& renderAssetManager, FILE* fp, std::vector<std::string> motionNames);
		static bool exportGeometry(SmartBody::SBRenderAssetManager& renderAssetManager, FILE* fp, SrModel& model, double scale);
