...
namespace SmartBody {
void saveSceneSettings(SBRenderScene& renderScene, std::ostream& ostream) {
...
void save(SBRenderScene& renderScene, std::ostream& ostream, bool remoteSetup, const std::string& mediaPath) {
	ostream << "# Autogenerated by SmartBody\n";
	...
	saveCharacters(renderScene, ostream, remoteSetup);
	saveServices(renderScene, ostream, remoteSetup);

}

void exportScene(SBRenderScene& renderScene, std::ostream& ostream, const std::vector<std::string>& aspects, const std::string& mediaPath, bool remoteSetup) {
	ostream << "# Autogenerated by SmartBody\n";
...
void exportScenePackage(SBRenderScene& renderScene, std::string outDir, const std::string& outZipArchiveName) {
	...
	if (file.good()) {
		save(renderScene, file, false, "__FILE__");
		file.close();
	} else {
...
void saveCharacters(SBRenderScene& renderScene, std::ostream& ostream, bool remoteSetup) {
	...
	for (const auto& characterIter : characters) {
		...
		auto* steerManager = renderScene.mScene.getSteerManager();
	...
	// enable steering
	if (!renderScene.mScene.getSteerManager()->getSteerAgents().empty()) {
