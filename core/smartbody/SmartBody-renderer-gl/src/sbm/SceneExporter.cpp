...
SBAPI void save(SBRenderScene& renderScene, std::ostream& ostream, bool remoteSetup, const std::string& mediaPath) {
	ostream << "# Autogenerated by SmartBody\n";
...
SBAPI void exportScene(SBRenderScene& renderScene, std::ostream& ostream, const std::vector<std::string>& aspects, const std::string& mediaPath, bool remoteSetup) {
	ostream << "# Autogenerated by SmartBody\n";
