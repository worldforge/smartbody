...
BMLLocomotionObject::BMLLocomotionObject() : BMLObject()
{
	...
	types.emplace_back("basic");
	types.emplace_back("example");
	types.emplace_back("procedural");
	...
	manners.emplace_back("walk");
	manners.emplace_back("jog");
	manners.emplace_back("run");
	manners.emplace_back("sbm:step");
	manners.emplace_back("sbm:jump");
