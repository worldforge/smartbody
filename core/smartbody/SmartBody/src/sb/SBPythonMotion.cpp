...
namespace boost
{
	...
	template<> const volatile SmartBody::SBMotionNode* get_pointer(const volatile SmartBody::SBMotionNode* p) { return p; }
	template<> const volatile SmartBody::SBMotionTransitionEdge* get_pointer(const volatile SmartBody::SBMotionTransitionEdge* p) { return p; }
	template<> const volatile SmartBody::SBMotionGraph* get_pointer(const volatile SmartBody::SBMotionGraph* p) { return p; }
	template<> const volatile SmartBody::SBMotionGraphManager* get_pointer(const volatile SmartBody::SBMotionGraphManager* p) { return p; }
}
#endif 
...
void pythonFuncsMotion()
{
	...
	boost::python::class_<SBMotion, boost::python::bases<SBObject> >("SBMotion")
		...
		.def("mirror2", &SBMotion::mirror2, boost::python::return_value_policy<boost::python::reference_existing_object>(), "Mirrors the motion by adding a from/to list of mappings.")
		...
		.def("smoothCycleWithBase", &SBMotion::smoothCycleWithBase, boost::python::return_value_policy<boost::python::reference_existing_object>(), "Build the smooth cycle the motion.")
		...
		.def("getChannelPos", &SBMotion::getChannelPos, "Get the channel position. \n Input: SBJoint, time \n Output: joint position")
		.def("getChannelQuat", &SBMotion::getChannelQuat, "Get the channel quat. \n Input: SBJoint, time \n Output: joint quat")
		.def("getChannelMat", &SBMotion::getChannelMat, "Get the channel matrix. \n Input: SBJoint, time \n Output: joint matrix")
		.def("getChannelPosFrame", &SBMotion::getChannelPosFrame, "Get the channel position. \n Input: SBJoint, frame \n Output: joint position")
		.def("getChannelQuatFrame", &SBMotion::getChannelQuatFrame, "Get the channel quat. \n Input: SBJoint, frame \n Output: joint quat")
		.def("getChannelMatFrame", &SBMotion::getChannelMatFrame, "Get the channel matrix. \n Input: SBJoint, frame \n Output: joint matrix")
		.def("setChannelPosFrame", &SBMotion::setChannelPosFrame, "Set the channel position. \n Input: SBJoint, frame \n Output: joint position")
		.def("setChannelQuatFrame", &SBMotion::setChannelQuatFrame, "Set the channel quat. \n Input: SBJoint, frame, quat \n Output: joint quat")
		.def("setChannelMatFrame", &SBMotion::setChannelMatFrame, "Set the channel matrix. \n Input: SBJoint, frame, matrix \n Output: joint matrix")
		...
		.def("setTimeStart", &SBMotion::setTimeStart, "Sets the start time of the motion.")
		.def("setTimeReady", &SBMotion::setTimeReady, "Sets the  ready time of the motion.")
		.def("setTimeStrokeStart", &SBMotion::setTimeStrokeStart, "Sets the  stroke start time of the motion.")
		.def("setTimeStroke", &SBMotion::setTimeStroke, "Sets the  stroke time of the motion.")
		.def("setTimeStrokeEnd", &SBMotion::setTimeStrokeEnd, "Sets the  stroke end time of the motion.")
		.def("setTimeRelax", &SBMotion::setTimeRelax, "Sets the  relax time of the motion.")
		.def("setTimeStop", &SBMotion::setTimeStop, "Sets the  stop time of the motion.")
