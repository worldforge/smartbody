#ifndef _SBMJAVASCRIPTCLASS_
#define _SBMJAVASCRIPTCLASS_
...
namespace SmartBody 
{
	...
	class JavascriptController :  public SBController
	{
	public:
		std::string controllerType;
		JavascriptController() : SBController() { controllerType = "javascript";}
		virtual void start() {};
		virtual void init() {};
