...
namespace boost
{
	...
	template<> const volatile SmartBody::SBScene* get_pointer(const volatile SmartBody::SBScene* p) { return p; }
}
#endif
...
void pythonFuncsScene()
{
		...
		.def("addSkeletonDefinition", &SBScene::addSkeletonDefinition, boost::python::return_value_policy<boost::python::return_by_value>(), "Add an new empty skeleton into system. \n Input: skeleton name \nOutput: skeleton object")
...
//		.def("getCameraNames", &SBScene::getCameraNames, "Gets the names of all the cameras available.")
		...
		// deprecated
		.def("createSkeleton", &SBScene::createSkeleton, boost::python::return_value_policy<boost::python::return_by_value>(), "Creates a new skeleton given a skeleton definition.")
		.def("getSkeleton", &SBScene::getSkeleton, boost::python::return_value_policy<boost::python::return_by_value>(), "Returns the skeleton object given its name. \n Input: skeleton name \nOutput: skeleton object")
