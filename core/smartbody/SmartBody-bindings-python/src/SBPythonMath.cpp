...
void pythonFuncsMath()
{
    ...
    .def("getEuler", &SrQuat::getEuler, boost::python::return_value_policy<boost::python::return_by_value>(), "Gets the euler angle of the quaternion.")
    .def("setEuler", &SrQuat::setEuler, "sets the data in the quaterion using input Euler angles")
		.def("getMat", &SrQuat::getMat, "returns the matrix equivalent")
