...
class MyEventHandler(SBEventHandler):
    ...
    def executeAction(self, event):
        ...
        if 'beat' in params:
            bml.execBML('ChrRachel',
                        '<speech type="text/plain">What is the meaning of this?</speech><face type="FACS" au="1" amount=".7" start="0" end="2"/><face '
                        'type="FACS" au="2" amount=".7" start="0" end="2"/>')
        if 'contemplate' in params:
            bml.execBML('ChrRachel',
                        '<speech type="text/plain">No, I don\'t want any more of those</speech><face type="FACS" au="7" amount="1.0" start="0" '
                        'end="3"/><face type="FACS" au="7" amount="1.0" start="0" end="3"/><face type="FACS" au="2" side="right" amount="1.0" start="0" '
                        'end="3"/>')
