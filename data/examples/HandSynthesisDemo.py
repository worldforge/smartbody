...
print("")
print(
    "Demonstrates using a set of gestures to synthesize hand and finger motion on top of a source motion that does not contain hand or finger animation data.")
