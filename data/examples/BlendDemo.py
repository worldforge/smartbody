...
chr0DSkeleton = scene.createSkeleton('ChrBrad.dae')
...
chr1D.setPosition(SrVec(-.9, .9, 0))
chr1D.createStandardControllers()
chr1D.setVec3Attribute('deformableMeshScale', .16, .16, .16)
...
chr2DSkeleton = scene.createSkeleton('ChrRachel.dae')
chr2D.setSkeleton(chr2DSkeleton)
chr2D.setPosition(SrVec(.9, 0, 0))
chr2D.createStandardControllers()
chr2D.setVec3Attribute('deformableMeshScale', .01, .01, .01)
chr2D.setStringAttribute('deformableMesh', 'ChrRachel.dae')
createRetargetInstance('test_utah.sk', 'ChrRachel.dae')
