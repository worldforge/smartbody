...
def speakRandomSentence():
    ...
    if currentTurn == 'ChrBrad':
        ...
        bml.execBML('ChrBrad',
                    '<speech type="text/plain">' + randomSentence + '</speech><head type="NOD" amount=".3"/><gaze target="ChrRachel" sbm:joint-range="NECK '
                                                                    'EYES"/>')
    ...
    # If Rachel's turn
        ...
        bml.execBML('ChrRachel',
                    '<speech type="text/plain">' + randomSentence + '</speech><head type="NOD" amount=".3"/><gaze target="ChrBrad" sbm:joint-range="NECK '
                                                                    'EYES"/>')
        currentTurn = 'ChrBrad'
