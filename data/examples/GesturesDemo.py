    ...
    def update(self, time):
        ...
        if diff >= delay:
            ...
            bml.execBML('ChrBrad0',
                        '<gesture id="cbrad0" lexeme="DEICTIC" type="YOU" stroke="0" relax="2" sbm:joint-range="l_shoulder" sbm:frequency="0.09" '
                        'sbm:scale="0.04"/>')
            bml.execBML('ChrBrad0',
                        '<gesture id="cbrad0" lexeme="METAPHORIC" type="OBLIGATION" mode="LEFT_HAND" stroke="3" relax="5" sbm:joint-range="l_shoulder" '
                        'sbm:frequency="0.09" sbm:scale="0.04"/>')
            bml.execBML('ChrBrad0',
                        '<gesture id="cbrad0" lexeme="DEICTIC" type="ME" stroke="6" relax="8" sbm:joint-range="l_shoulder" sbm:frequency="0.09" '
                        'sbm:scale="0.04"/>')
            # No pauses
