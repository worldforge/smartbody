class GUIManager:
    ...
    def getAllWidgetsHeight(self):
        height = len(self.buttonList) * (self.buttonHeight + 5) + len(self.sliderList) * (self.sliderHeight + 5) + len(self.textList) * (
                    self.staticTextHeight + 5) + len(self.chkBoxList) * (self.chkBoxHeight + 5) + 10
