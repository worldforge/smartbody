...
def testRetargetCharacter(charName):
	...
	scene.commandAt(14.0, 'set pawn '+pawnTargetName+' world_offset x ' + str(pointPos.getData(0)) +' y ' + str(pointPos.getData(1)) + ' z ' + str(pointPos.getData(2)))	
	...
	scene.commandAt(18.0, 'set pawn '+pawnTargetName+' world_offset x ' + str(pointPos.getData(0)) +' y ' + str(pointPos.getData(1)) + ' z ' + str(pointPos.getData(2)))	
	...
	scene.commandAt(22.0, 'set pawn '+pawnTargetName+' world_offset x ' + str(pointPos.getData(0)) +' y ' + str(pointPos.getData(1)) + ' z ' + str(pointPos.getData(2)))	
	...
	scene.commandAt(26.0, 'set pawn '+pawnTargetName+' world_offset x ' + str(reachPos.getData(0)) +' y ' + str(reachPos.getData(1)) + ' z ' + str(reachPos.getData(2)))
	...
	scene.commandAt(30.0, 'set pawn '+pawnTargetName+' world_offset x ' + str(reachPos.getData(0)) +' y ' + str(reachPos.getData(1)) + ' z ' + str(reachPos.getData(2)))	
	...
	# test locomotion
	bml.execBML(charName, '<locomotion target="'+str(position.getData(0)-sbChar.getHeight()*0.1) +' '+ str(position.getData(2)-sbChar.getHeight()*3) + '" start="37"/>')
